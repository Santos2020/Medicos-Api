...
public class ValidadorPacienteSemOutraConsultaNoDia implements ValidadorAgendamentoDeConsultas {
    ...
    public void validar(DadosAgendamentoConsulta dados){
        ...
        var pacientePossiuOutraConsultaNoDia = repository.existsPacienteByIdAndDataBetween(dados.idPaciente(), primeiroHorario, ultimoHorario);
        if (pacientePossiuOutraConsultaNoDia){
